...
exports.SELECT_WATER_RESOURCE_WITH_PROPERTY_QUERY = exports.SELECT_WATER_RESOURCE_BY_PROPERTY_ID_QUERY = exports.SELECT_WATER_RESOURCE_QUERY = exports.SELECT_WATER_RESOURCE_BY_PROPERTY_QUERY = exports.WATER_RESOURCE_DISTRIC_AVAILABILITY_QUERY = exports.SELECT_PROPERTY_WATER_RESOURCES_BY_AREA_QUERY = exports.SELECT_PROPERTY_WATER_RESOURCES_BY_DISTRICT_QUERY = exports.SELECT_PROPERTY_WATER_RESOURCES_QUERY = exports.WATER_RESOURCE_AVAILABILITY_BY_AREA_QUERY = exports.WATER_RESOURCE_AVAILABILITY_BY_DISTRICT_QUERY = exports.WATER_RESOURCE_AVAILABILITY_SUMMARY_QUERY = void 0;
exports.WATER_RESOURCE_AVAILABILITY_SUMMARY_QUERY = `SELECT 
...
exports.WATER_RESOURCE_AVAILABILITY_BY_DISTRICT_QUERY = `SELECT
    d.id,
    d."NM_DIST",
  ...
  WHERE d.id = $1
  GROUP BY d.id`;
exports.WATER_RESOURCE_AVAILABILITY_BY_AREA_QUERY = `SELECT
    COUNT(*)::integer AS total_properties,
    COUNT(CASE WHEN rh.banheiro_id IS NOT NULL THEN 1 END)::int AS has_banheiro,
    COUNT(CASE WHEN rh.banheiro_id IS NULL THEN 1 END)::int AS not_has_banheiro,
  ...
  WHERE ST_DWithin(
    ...
    $3)`;
exports.SELECT_PROPERTY_WATER_RESOURCES_QUERY = `SELECT
    p.id, 
...
exports.SELECT_PROPERTY_WATER_RESOURCES_BY_DISTRICT_QUERY = `SELECT
    p.id, 
    ST_AsGeoJSON(p.geom) AS geojson,
    ST_X(p.geom) AS lng, 
    ST_Y(p.geom) AS lat,
  ...
  JOIN distritos d ON p.distrito = d."NM_DIST"
  WHERE d.id = $3`;
exports.SELECT_PROPERTY_WATER_RESOURCES_BY_AREA_QUERY = `SELECT
    p.id, 
    ST_AsGeoJSON(p.geom) AS geojson,
    ST_X(p.geom) AS lng, 
    ST_Y(p.geom) AS lat,
  ...
  WHERE ST_DWithin(
    ...
    $5)`;
exports.WATER_RESOURCE_DISTRIC_AVAILABILITY_QUERY = `SELECT
    d.id,
    d."NM_DIST",
    ST_AsGeoJSON(ST_Collect(d.geom)) AS geojson,
    COUNT(*)::integer AS total_properties,
  ...
  JOIN distritos d ON p.distrito = d."NM_DIST"
  GROUP BY d.id`;
exports.SELECT_WATER_RESOURCE_BY_PROPERTY_QUERY = `SELECT
  ...
  JOIN propriedades p ON p.id = rh.propriedade_id
  WHERE p.id = $1`;
exports.SELECT_WATER_RESOURCE_QUERY = `SELECT
...
exports.SELECT_WATER_RESOURCE_BY_PROPERTY_ID_QUERY = `SELECT
  rh.*,
  c.tipo_cisterna,
  c.capacidade_armazenamento AS capacidade_cisterna,
  cp.fornecedor_carro_pipa,
...
exports.SELECT_WATER_RESOURCE_WITH_PROPERTY_QUERY = `SELECT
  rh.*,
  c.tipo_cisterna,
  c.capacidade_armazenamento AS capacidade_cisterna,
  cp.fornecedor_carro_pipa,
